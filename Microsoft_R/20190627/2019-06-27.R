remoteLogin(
  "http://mlso.southeastasia.cloudapp.azure.com:12800",
  session = TRUE,
  diff = TRUE,
  commandline = TRUE,
  username = "admin",
...
sqlConnString <- "Driver=SQL Server;Server=mysvn.database.windows.net; Database=AirlineData;Uid=admin2019;Pwd=Pa200rd.56$$"
...
test_data = RxXdfData("C:\\Users\\user\\Documents\\bigdata\\9_Microsoft R\\20190627\\2000.xdf")
